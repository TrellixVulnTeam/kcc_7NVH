...
def train(args):
    ...
    torch.save({'model': tst_model.state_dict(),
                ...
                'total_latent': total_latent}, "/HDD/yehoon/data/nv_tst_model.pth")

    with open("/HDD/yehoon/data/nv_tst_train_target_decode.txt", "w", encoding="utf8") as tf, open(
            "/HDD/yehoon/data/nv_tst_train_output_decode.txt", "w", encoding="utf8") as of:
    ...
    with open ("/HDD/yehoon/data/nv_tst_valid_target_decode.txt", "w", encoding="utf8") as tf, open("/HDD/yehoon/data/nv_tst_valid_output_decode.txt", "w", encoding="utf8") as of:
    ...
    torch.save({'model': nmt_model.state_dict(),
                'encoder': nmt_model.encoder.state_dict()}, "/HDD/yehoon/data/nv_ed_nmt_model.pth")

    with open("/HDD/yehoon/data/nv_ed_nmt_train_target_decode.txt", "w", encoding="utf8") as tf, open("/HDD/yehoon/data/nv_ed_nmt_train_output_decode.txt", "w", encoding="utf8") as of:
    ...
    with open("/HDD/yehoon/data/nv_ed_nmt_valid_target_decode.txt", "w", encoding="utf8") as tf, open(
            "/HDD/yehoon/data/nv_ed_nmt_valid_output_decode.txt", "w", encoding="utf8") as of:
