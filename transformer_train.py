...
from models.jadore.model import Transformer
from models.jadore.optim import ScheduledOptim
...
def main():
    ...
    parser.add_argument('-warmup','--n_warmup_steps', type=int, default=40)
